...
export class Terminal extends Component {
  constructor() {
    ...
    this.child_directories = {
      ...
      books: ["Jean-Paul-Sartre_Being_and_Nothingness.pdf"],
      skills: ["making things", "breaking things"],
      projects: [
        "cypresss-slack-reporter",
        "cypress-pact",
        "jest-pact",
        "msw-pact",
    ...
    return (
      <React.Fragment key={id}>
        <div className="flex w-full h-5">
          <div className="flex">
            <div className=" text-ubt-green">{config.authorEmail}</div>
      ...
      case "code":
        if (words[0] === ".") {
          ...
          result =
            "Command '" +
            main +
            "' not found, or not yet implemented.<br>Available Commands: [ cd, ls, echo, clear, exit, mkdir,code]";
        }
        break;
      case "echo":
