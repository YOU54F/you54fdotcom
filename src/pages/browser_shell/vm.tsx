...
// // const { V86Starter } = require("../../components/v86/libv86");
// import { V86Starter } from "../../components/v86/libv86";
// import { config } from "./config";
// import { hasState, getState, saveState } from "./cache";
// import { GiConsoleController } from "react-icons/gi";
// // What our shell prompt looks like, so we can wait on it.
// const prompt = "/ # ";
// const getVMStartOptions = () => {
//   const options = Object.create(config.defaultEmulatorOptions);
//   console.log("getVMStartOptions");
//   console.log(options);
...
//   const hasCachedVM = await hasState();
//   if (hasCachedVM) {
//     try {
//       await warmBoot(term);
//     } catch (err) {
...
//   console.log("got vm start opts");
//   emulator = new V86Starter(options);
//   console.log("got emuluator, storing state on  boot");
...
//   console.log("got prompt, starting term");

//   startTerminal(emulator, term);
//   emulator.save_state(saveState);
